  ...
  function(el) {
    ...
    return (
        <div>
            ...
            <Header />
            <div className="flex flex-col gap-5 justify-center items-center w-[100%] bg-white">
                ...
                <button onClick={go} className='bg-white p-2 hover:bg-black hover:text-white text-black/40 border-black/10 border-[0.2px] '>nah, take me to the meme gallery</button>
                </div>

                <div className='grid grid-cols-1 lg:grid-cols-2 place-items-center w-[100%] px-2 '>
                    <div className='colspan-1 w-[100%] h-[100%] flex justify-center items-center border-[0.2px] border-black/30 lg:bg-black'>
                    ...
                    <div className='colspan-1 relative w-[100%] p-10 flex flex-col gap-5 justify-center items-center border-[0.2px] border-t-0 sm:border-t-[0.2px] border-black/30'>
                    
                    <span className=' absolute top-0 head text-sm text-center text-white px-1 bg-black'>options</span>

                        <label htmlFor="inputag" className="bg-black text-white input cursor-pointer flex flex-col align-center items-center text-sm  px-1 py-1" >
                        Upload an image
                        ...
                        <span className='text-sm text-slate-300 mb-3'>Drag the text by holding it and position it where you'd like</span>
                        ...
                        <button className=' py-3 bg-black text-green-100 mt-1 w-[80%] min-w-[300px] ease-in duration-150 hover:bg-red-900' 
                        onClick={(e) => exportComponentAsJPEG(memeRef)}>Download your custom <span className='head'>grfx</span></button> 
