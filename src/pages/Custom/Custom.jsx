    ...
    <div>
      ...
      <div className="flex flex-col gap-5 justify-center items-center w-[100%] bg-white">
        <div className="p-5 flex flex-col justify-center gap-3">
          ...
          <button
            onClick={go}
            className="bg-white p-2 hover:bg-black hover:text-white text-black/40 border-black/10 border-[0.2px] "
          >
            nah, take me to the meme gallery
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 place-items-center w-[100%] px-2 ">
          <div className="colspan-1 w-[100%] h-[100%] flex justify-center items-center border-[0.2px] border-black/30 lg:bg-black">
            <div
              ref={memeRef}
              id="meme"
              className="relative overflow-hidden w-[250px] h-[250px] lg:w-[300px] lg:h-[300px] mx-auto flex justify-center items-center rounded-md bg-gradient-to-bl from-black to-red-900 mb-5 mt-5"
            >
              <Draggable>
                <h1
                  id="memetext"
          ...
          <div className="colspan-1 relative w-[100%] p-10 flex flex-col gap-5 justify-center items-center border-[0.2px] border-t-0 sm:border-t-[0.2px] border-black/30">
            ...
            <label
              htmlFor="inputag"
              className="bg-black text-white input cursor-pointer flex flex-col align-center items-center text-sm  px-1 py-1"
            >
              Upload an image
              <input
                type="file"
            ...
            <div className=" flex flex-col justify-center items-center gap-3">
              <span className="text-slate-600 text-sm">
                Alter font size{" "}
                <span className="text-xs text-slate-400">if need be</span>
              </span>
