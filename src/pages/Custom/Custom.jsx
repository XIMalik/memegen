            ...
            <div className="App flex flex-col gap-1 justify-center items-center w-[100%] bg-white">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 place-items-center w-[100%] px-2 '>
                    ...
                    <span className=' absolute top-0 head text-sm text-center text-white px-1 bg-black'>options</span>
                        ...
                        <label htmlFor="inputag" className="hover:bg-black hover:text-white input cursor-pointer gap-3 flex flex-col align-center items-center text-sm text-black head px-1 py-1" >
                        Upload an image
                        ...
                        <span className='text-slate-600 text-sm'>Change the text color</span>
                        ...
                        <div className=' flex flex-col justify-center my-5 items-center gap-3'>
                        <span className='text-slate-600 text-sm'>Change the font size <span className='text-xs text-slate-400'>if need be</span></span>
                        ...
                        <div className='flex flex-col gap-5 justify-center items-center mt-5 w-[100%] px-5 md:px-2'>
                        <span className='text-left text-slate-600'>Input some text to complete your <span className='head text-black'>grfx</span></span>
                        ...
                        <button className=' py-3 bg-black text-green-100 mt-5 w-[80%] min-w-[300px] ease-in duration-150 hover:bg-red-900 mb-20' onClick={(e) => exportComponentAsJPEG(memeRef)}>Download your custom <span className='head'>grfx</span></button>   
                    </div>
                </div>
            </div>
            <Footer/>
